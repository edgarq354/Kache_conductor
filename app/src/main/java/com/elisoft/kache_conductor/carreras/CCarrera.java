...
public class CCarrera {
    ...
    public CCarrera(int id,double latitud_inicio,double longitud_inicio,double latitud_fin,double longitud_fin,String distancia,String fecha_inicio,String fecha_fin,String tiempo,int id_pedido,int id_usuario,double monto,String ruta,String numero,String direccion_inicio,String direccion_fin)    {
        this.id=id;
