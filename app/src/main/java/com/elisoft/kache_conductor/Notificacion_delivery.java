...
public class Notificacion_delivery extends AppCompatActivity  implements OnMapReadyCallback, View.OnClickListener {
    ...
    TextView tv_monto_carrito,tv_monto_envio;
    ...
    de.hdodenhof.circleimageview.CircleImageView im_empresa;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_notificacion_delivery);
        ...
        im_empresa=findViewById(R.id.im_empresa);
...
//1800 es 3 minutos.
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        servicio_get_pedido_por_id_pedido(id_pedido);
    }
    ...
    public void onClick(View v) {
        ...
        {
            servicio_aceptar_delivery_conductor();
        }
    ...
    public  void servicio_aceptar_delivery_conductor(){
        SharedPreferences perfil=getSharedPreferences("perfil_conductor",MODE_PRIVATE);

        pDialog = new ProgressDialog(Notificacion_delivery.this);
            pDialog.setTitle(getString(R.string.app_name));
            pDialog.setMessage("Aceptando servicio");
            ...
            try {
                ...
                jsonParam.put("ci", perfil.getString("ci",""));
                jsonParam.put("placa", perfil.getString("placa",""));
                String url=getString(R.string.servidor)+"frmPedido.php?opcion=aceptar_delivery_conductor";
    ...
    public  void servicio_get_pedido_por_id_pedido(int id_pedido){
...
Toast.makeText(this,"Obteniendo información",Toast.LENGTH_SHORT).show();
        ...
        try {
            JSONObject jsonParam= new JSONObject();
            jsonParam.put("id_pedido", String.valueOf(id_pedido));
            String url=getString(R.string.servidor)+"frmPedido.php?opcion=get_pedido_por_id";
                        ...
                        public void onResponse(JSONObject respuestaJSON) {
                            try {
                                ...
                                if (suceso.getSuceso().equals("1")) {
                                    ...
                                    String id_pedido=usu.getJSONObject(0).getString("id");
                                    String id_usuario=usu.getJSONObject(0).getString("id_usuario");
                                    String direccion=usu.getJSONObject(0).getString("direccion");
                                    String nombre_lugar=usu.getJSONObject(0).getString("nombre_lugar");
                                    String monto_pedido=usu.getJSONObject(0).getString("monto_pedido");
                                    String monto_total=usu.getJSONObject(0).getString("monto_total");
                                    String direccion_lugar=usu.getJSONObject(0).getString("direccion_lugar");
                                    String direccion_logo_lugar=usu.getJSONObject(0).getString("direccion_logo_lugar");
                                    double latitud=Double.parseDouble(usu.getJSONObject(0).getString("latitud"));
                                    double longitud=Double.parseDouble(usu.getJSONObject(0).getString("longitud"));
                                    ...
                                    Picasso.with(Notificacion_delivery.this).load(getString(R.string.servidor_web)+"storage/"+direccion_logo_lugar).placeholder(R.drawable.ic_empresa).into(im_empresa);
                                    tv_nombre.setText(nombre_lugar);
                                    tv_direccion.setText(direccion_lugar);
                                    m_empresa.setTitle(nombre_lugar);
                                    m_empresa.setPosition(new LatLng(latitud_lugar,longitud_lugar));
                                    tv_monto_carrito.setText("Pedido: "+monto_pedido+" Bs");
                                    tv_monto_envio.setText("Envio: "+monto_total+" Bs");
