    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try{
            ...
            if (token != null || token == "") {
                ...
                mensaje_con_final("No se a podido generar el Token. porfavor active sus datos de Red e instale Google Pay Service");
            }
        }catch (Exception e)
        {
...
//guardar datos del conductor
    ...
    public void mensaje_con_final(String mensaje)
    {
        AlertDialog.Builder builder = new AlertDialog.Builder(this);
        builder.setTitle("Importante");
        builder.setMessage(mensaje);
